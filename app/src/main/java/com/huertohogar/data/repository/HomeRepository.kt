...
class HomeRepository(
    ...
    // Obtiene los productos desde la base de datos, solo los activos
    fun getProducts(): Flow<List<Product>> {
        // Retorna productos activos desde la base de datos
        return productDao.getActiveProducts()
    }
    
    // Funcion auxiliar para obtener productos iniciales directamente
