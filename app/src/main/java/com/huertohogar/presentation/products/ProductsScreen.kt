...
fun ProductsScreen(
    ...
    Scaffold(
        ...
        contentWindowInsets = WindowInsets(0.dp) // Eliminar insets del Scaffold
    ) { paddingValues ->
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    ...
                    .onFocusChanged { focusState ->
                        // Si el campo pierde el foco y hay resultados, ocultar teclado
            ...
            when {
                ...
                uiState.error != null -> {
                    ...
                    LazyVerticalGrid(
                        ...
                        //funcion que se encarga de agregar un producto al carrito cuando hacemos click en agregar al carrito
